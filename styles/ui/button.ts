...
export const buttonStyles = compose(
	...
	cva({
		base: [
			...
			'transform active:translate-y-[0.0625rem]'
		],
		variants: {
			variant: {
				unset: null,
			...
			isDisabled: {
				true: 'cursor-not-allowed opacity-38 forced-colors:text-[GrayText] forced-colors:group-disabled:text-[GrayText] forced-colors:disabled:text-[GrayText]',
